...
export const products: Product[] = [
  ...
  { id: "garri-yellow-2kg", name: "Yellow Garri", category: "pantry", price: 13.95, unit: "2kg", description: "Toasted yellow garri with a rich cassava flavour. Perfect for drinking cold.", image: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80", featured: false },
  ...
  { id: "egusi-500g", name: "Ground Egusi", category: "pantry", price: 16.95, unit: "500g", description: "Stone-ground melon seeds. Nutty and rich: the soul of egusi soup.", image: "https://images.unsplash.com/photo-1600189020440-58f9dd6fbe45?w=600&q=80", featured: false, tag: "Popular" },
  { id: "stockfish-500g", name: "Stockfish Pieces", category: "pantry", price: 24.95, unit: "500g", description: "Norwegian-dried stockfish. Gives depth to any pot of soup.", image: "https://images.unsplash.com/photo-1511995386821-69ded46fcf63?w=600&q=80", featured: false },
  { id: "ofe-onugbu-leaf", name: "Bitter Leaf (Onugbu)", category: "pantry", price: 8.95, unit: "100g", description: "Dried bitter leaf, essential for ofe onugbu and Igbo soups.", image: "https://images.unsplash.com/photo-1528821128474-27f963b062bf?w=600&q=80", featured: false },
  { id: "ogbono-200g", name: "Ogbono Seeds", category: "pantry", price: 19.95, unit: "200g", description: "Wild mango seeds. Creates that irresistible draw soup texture.", image: "https://images.unsplash.com/photo-1504754524776-8f4f37790ca0?w=600&q=80", featured: false },
  // Spices
  ...
  { id: "suya-spice-150g", name: "Suya Spice Blend", category: "spices", price: 9.95, unit: "150g", description: "Authentic yaji mix with groundnuts, ginger, and paprika. Northern Nigeria in a jar.", image: "https://images.unsplash.com/photo-1466027397211-20d0f2449a3c?w=600&q=80", featured: true },
  { id: "uziza-leaf-50g", name: "Uziza Leaf", category: "spices", price: 7.50, unit: "50g", description: "Peppery dried uziza, for ofe akwu, fisherman soup, and pepper soup.", image: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=600&q=80", featured: false },
